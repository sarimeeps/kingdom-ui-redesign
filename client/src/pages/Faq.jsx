        ...
        <section className='flex flex-col mt-6 mb-16 max-w-300 w-full'>
          ...
          <form action="" className='grid grid-cols-2 gap-5 max-w-150 mt-6' id='query'>
            <label htmlFor="name">
              ...
              <input type="text" id='name' name='name' placeholder='Name' className='bg-[#fff] border border-gray-400 rounded-sm p-2 w-full focus:border-[#8F3A6D] focus:outline-none focus:ring-1 focus:ring-[#8F3A6D] shadow-xs' />
            </label>
            <label htmlFor="email">
              <span className='sr-only'>Email</span>
              <input type="email" id='email' name='email' placeholder='Email' className='bg-[#fff] border border-gray-400 rounded-sm p-2 w-full focus:border-[#8F3A6D] focus:outline-none focus:ring-1 focus:ring-[#8F3A6D] shadow-xs' />
            </label>
            <label htmlFor="tel" className='col-span-2'>
              <span className='sr-only'>Phone Number</span>
              <input type="tel" id='tel' name='tel' pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' placeholder='Phone Number' className='bg-[#fff] border border-gray-400 p-2 rounded-sm w-full focus:border-[#8F3A6D] focus:outline-none focus:ring-1 focus:ring-[#8F3A6D] shadow-xs' />
            </label>
            <label htmlFor="query" className='col-span-2'>
              <span className='sr-only'>Question</span>
              <textarea id='query' name='query' placeholder='Question *' className='bg-[#fff] border border-gray-400 p-2 rounded-sm w-full h-30 focus:border-[#8F3A6D] focus:outline-none focus:ring-1 focus:ring-[#8F3A6D] shadow-xs' required />
            </label>
